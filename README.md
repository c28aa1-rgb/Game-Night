...
strict SAME/DIFFERENT decision for every labeled answer pair. The server rejects
unknown or duplicate pair IDs, prevents incomplete transitive chains from
becoming broad groups, applies only validated merges, and reveals automatically.
