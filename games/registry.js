...
module.exports = [
  ...
  },
  {
    id: 'wavelength',
    name: 'Wavelength',
    tagline: 'Find the exact point where your minds meet.',
    players: '4+ players \u00b7 TV + 2 phones',
    age: '11+',
    time: '15-30 min',
    accent: '#F3B342',
    art: '/hub/art/wavelength.webp',
    basePath: '/wavelength',
    type: 'node',
    status: 'draft',
  },
  {
    id: 'chameleon',
    name: 'Chameleon',
    tagline: 'Blend in. Figure it out. Don’t get caught.',
