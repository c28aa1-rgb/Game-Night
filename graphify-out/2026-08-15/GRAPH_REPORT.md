...
## Corpus Check
- 89 files · ~526,005 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1488 nodes · 3074 edges · 71 communities (63 shown, 8 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.52)
...
Cohesion: 0.17
Nodes (11): { app, server }, esc(), express, fs, games, HUB_DIR, hubTemplate, joinCodes (+3 more)
...
Cohesion: 0.29
Nodes (4): assert, Engine, questions, test

### Community 4 - "handleJoin"
Cohesion: 0.33
Nodes (6): attach(), createRoom(), freeCode(), handleJoin(), handleRegisterTv(), reassignHost()
...
### Community 7 - "wavelength.test.js"
Cohesion: 0.50
Nodes (3): assert, test, wavelength
...
Cohesion: 0.05
Nodes (54): activeSets, activeSetSummary(), activeSongs(), { app, server, io }, beginPlayback(), broadcast(), buildChoices(), clearTimers() (+46 more)
...
Cohesion: 0.05
Nodes (43): dotenv, esbuild, express, ffmpeg-static, motion, msedge-tts, dependencies, dotenv (+35 more)
...
Cohesion: 0.08
Nodes (23): activeSession(), advance(), { app, io }, beginTurn(), broadcast(), CODE_WORDS, crypto, drawPrompt() (+15 more)
...
### Community 70 - "host.js"
Cohesion: 0.15
Nodes (10): { app }, crypto, joinCodes, pendingClaims, QRCode, app, express, http (+2 more)
...
Cohesion: 0.16
Nodes (22): bindEvents(), claimedTeam(), closeCardMenu(), closeKickMenu(), dismissStartNotice(), handleGlobalPointer(), handleHashRoute(), kickSpymaster() (+14 more)
...
Cohesion: 0.38
Nodes (7): buildCard(), dealIn(), isRevealed(), openCardMenu(), paintBoard(), renderList(), shuffleFlourish()
...
Cohesion: 0.13
Nodes (22): armExecution(), bothSeated(), cap(), clearBoard(), closeQrOverlay(), isHost(), openKickMenu(), openQrOverlay() (+14 more)
...
Cohesion: 0.11
Nodes (23): { app, io }, canControl(), CODE_WORDS, crypto, dropRoom(), Engine, express, findBySocket() (+15 more)

### Community 131 - "herd-mentality/engine.js"
Cohesion: 0.17
Nodes (10): beginReview(), buildGroups(), chooseQuestion(), enabledQuestions(), normalizeAnswer(), PHASES, splitAnswer(), startMatch() (+2 more)
...
## Knowledge Gaps
- **304 isolated node(s):** `test`, `assert`, `{ spawn }`, `path`, `net` (+299 more)
...
- **Why does `app` connect `host.js` to `server.js`, `hitster/server.js`, `hues-cues/server.js`, `wavelength/server.js`, `mafia/server.js`, `herd-mentality/server.js`, `chameleon/server.js`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `io` connect `host.js` to `hitster/server.js`, `hues-cues/server.js`, `wavelength/server.js`, `mafia/server.js`, `herd-mentality/server.js`, `chameleon/server.js`?**
...
- **Should `mafia/public/sfx.js` be split into smaller, more focused modules?**
  _Cohesion score 0.10983606557377049 - nodes in this community are weakly interconnected._
- **Should `hitster/public/tv.js` be split into smaller, more focused modules?**
